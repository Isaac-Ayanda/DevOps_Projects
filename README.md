...
9. [LOAD BALANCER SOLUTION WITH APACHE](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/09.Load-Balancer-Solution-With-Apache/readme.md)

10. [CONTINOUS INTEGRATION PIPELINE FOR TOOLING WEBSITE](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/10.CI-Pipeline-For-Tooling-Website/readme.md)

11. [LOAD BALANCER SOLUTION WITH NGINX AND SSL/TLS](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/11.LB-Solution-With-Nginx-and-SSL-TLS/readme.md)

12. [ANSIBLE CONFIGURATION MANAGEMENT (Automate project 7 to 10)](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/12.Ansible-Automation-of-Project7-to-10/readme.md)

13. [ANSIBLE REFACTORING AND STATIC ASSIGNMENTS (IMPORTS AND ROLES)](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/13.Ansible-Refactoring-Assignments-and-Imports/readme.md)

14. [ANSIBLE DYNAMIC ASSIGNMENTS (INCLUDE) AND COMMUNITY ROLES](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/14.Ansible-Dynamic-Assigments-Community-Roles/readme.md)


15. [EXPERIENCE CONTINUOUS INTEGRATION WITH JENKINS | ANSIBLE | ARTIFACTORY | SONARQUBE | PHP](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/15.CI-With-Jenkins-Ansible-Artifactory-Sonarqube-PHP/readme.md)


16. [AWS CLOUD SOLUTION FOR 2 COMPANY WEBSITES USING A REVERSE PROXY TECHNOLOGY](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/16.AWS_cloud-Solution-For-2_Company-Websites/readme.md)

17. [AUTOMATE INFRASTRUCTURE WITH IAC USING TERRAFORM PART 1](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/17.Automate-Infrastructure-With-IaC-Using-Terraform-Pt-1/readme.md)
    
18. [AUTOMATE INFRASTRUCTURE WITH IAC USING TERRAFORM. PART 2](https://github.com/Isaac-Ayanda/DevOps_Projects/blob/main/18.Automate-Infrastructure-With-IaC-Using-Terraform-Pt-2/readme.md)
